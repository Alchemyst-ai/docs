...
<Note>
  **Per-user vs Organization View**: 
  - **Per-user view** (`v1.context.view.*`) retrieves context data for the authenticated user only
  - **Organization view** (`v1.org.context.view`) allows you to view context data across multiple users within your organization by providing their user IDs
</Note>
