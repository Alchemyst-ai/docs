...
keywords: ['chrome-extension', 'memory-llm', 'integration']
---
...
The tutorial covers:
- Installing the [extension](https://chromewebstore.google.com/detail/alchemyst-ai-context-ai-m/aihninjmajjplfkgioojlgfdmagcmgkk?utm_source=tutotial&utm_medium=docs&utm_campaign=chrome_extension)
