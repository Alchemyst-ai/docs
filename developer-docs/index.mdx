...
Alchemyst acts as an intelligent layer between your user's raw data and your LLM.
...
flowchart LR
    ...
    A[User Data]:::node -->|Upload| B(Alchemyst Engine):::engine
    B -->|1. Chunking| C[(Vector Store)]:::store
    B -->|2. Graphing| D[(Knowledge Graph)]:::store
    
    E[User Query]:::node -->|Search| B
    B -->|Retrieves & Augments| F[LLM]:::node
    
    C -.->|Context| F
    D -.->|Context| F
    
    F --> G[AI Response]:::node
```
