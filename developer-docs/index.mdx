...
<div className="mx-auto w-screen max-w-[60vw] my-5 py-6 text-center">
  <h1 className="text-7xl sm:text-5xl font-bold my-3 dark:text-white text-[#f49025]">Alchemyst AI</h1>
  <p>
    Persistent, high-fidelity context for agents and LLMs - powered by your data.
  </p>
</div>
