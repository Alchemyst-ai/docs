---
title: 'Alchemyst Memory with Agno in Python'
description: 'Learn how to integrate Alchemyst AI memory with Agno framework for building intelligent Python applications'
---

## Overview

This tutorial demonstrates how to integrate **Alchemyst AI's memory capabilities** with the **Agno framework** in Python. You'll learn how to build context-aware applications that can remember, learn, and maintain state across interactions using both frameworks together.
...
- How to integrate Alchemyst AI memory with Agno framework
- Setting up persistent memory for Agno applications
- Building context-aware Python applications
- Best practices for memory management in AI systems
...
ALCHEMYST_ORG_ID=your_org_id_here
```
...
class PersonalAssistant(Agent):
    def __init__(self):
        self.alchemyst = AlchemystClient(
            api_key=os.getenv("ALCHEMYST_API_KEY"),
            org_id=os.getenv("ALCHEMYST_ORG_ID")
        )
