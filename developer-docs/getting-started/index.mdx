...
keywords: ['introduction', 'context', 'alchemyst']
---
...
- [**Quick Start**](/getting-started/quickstart) – Store and reuse context in minutes
- [**Cookbooks & Examples**](example-projects/team/cli-chatbot) – Real projects built by the community
- [**Core Principles**](/advanced/overview) – Learn how to best use Alchemyst AI
