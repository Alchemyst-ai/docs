---
title: "Quickstart - Contextual Agent"
description: "Build a context-aware AI system in minutes"
keywords: ['configuration', 'setup', 'getting started', 'rag']
---
